(function ($) {
  ...
  $(".tmp-intro-video-card-wrapper").each(function () {
    ...
    // Video Controls
    var $video_controls = $video_container.find(
  ...
  if (
    typeof ThemesparkObj !== "undefined" &&
    ThemesparkObj.intro_video_close_sound
  ) {
    ...
    if (
      $(".modal-header .close,.inbio-close-button,.close-menu-activation")
        .length > 0
    ) {
